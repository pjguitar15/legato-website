...
export const metadata: Metadata = {
  title: 'Sound & Lighting Services for Events | Simple Wedding Setup',
  description:
    'High-quality sound systems and professional lighting services for weddings, corporate events, and celebrations. Simple Wedding Setup.',
}
...
export default function page() {
  return (
    <main className='flex flex-col gap-7'>
      <Packages category='corporate-events' eventType='wedding' />
