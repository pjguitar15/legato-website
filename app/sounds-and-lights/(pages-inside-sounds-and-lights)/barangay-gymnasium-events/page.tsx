...
export const metadata: Metadata = {
  title: 'Sound & Lighting Services for Events | Barangay Gymnasium Events',
  description:
    'High-quality sound systems and professional lighting services for weddings, corporate events, and celebrations. Barangay Gymnasium Events.',
}
...
export default function page() {
  return (
    <main className='flex flex-col gap-7'>
      <Packages
        eventType='barangay-gymnasium-events'
