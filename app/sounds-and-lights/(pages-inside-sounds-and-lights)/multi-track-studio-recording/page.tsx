...
export const metadata: Metadata = {
  title: 'Sound & Lighting Services for Events | Multi-track Recording',
  description:
    'High-quality sound systems and professional lighting services for weddings, corporate events, and celebrations. Multi-track Recording.',
}
