  ...
  return (
    <motion.div className='bg-linear-to-br from-emerald-400/10 to-cyan-400/10 border border-white/10 p-8 backdrop-blur-sm'>
      ...
      <div className='flex items-center gap-4'>
        {testimonial.image && (
          <div className='w-12 h-12 rounded-full bg-linear-to-br from-emerald-400 to-cyan-400 flex items-center justify-center'>
...
const TestimonialSection = ({
  ...
  return (
    <section className='w-full py-32'>
      {title && (
        <h2 className='text-xl lg:text-2xl font-bold text-white text-center mb-16'>
          {title}
        </h2>
      )}
      <motion.div
