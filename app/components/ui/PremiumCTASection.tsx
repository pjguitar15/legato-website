  ...
  return (
    <section className='w-full py-12'>
      <motion.div
        ...
        className='relative overflow-hidden bg-gradient-to-r from-zinc-700/20 via-teal-600/20 to-zinc-700/20 border-y border-emerald-400/30 p-16 text-center'
      >
        ...
        <div className='relative z-10'>
          ...
          <motion.button
            ...
            className='px-12 py-4 bg-gradient-to-r from-emerald-400 to-cyan-400 text-black font-bold text-md hover:shadow-2xl hover:shadow-emerald-400/50 transition-all duration-300'
          >
            {buttonText}
          </motion.button>
        </div>
